...
public class ArchivesController {
    ...
    @ApiOperation(value = "档案信息-根据id删除")
    ...
    @ApiOperation(value = "档案信息-根据id更新")
    ...
    @ApiOperation(value = "档案信息-根据id查询")
    ...
    @ApiOperation(value = "档案信息-根据用户id获得info")
    @RequestMapping(value = "/getbyid", method = RequestMethod.GET)
    public Result getInfoById(Integer stuId) {
        return archivesService.getInfoByUserId(stuId);
    }
}
